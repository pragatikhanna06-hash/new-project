...
import {
  ShieldCheck, Scale, Landmark, Briefcase, ArrowRight, CheckCircle2, Quote, Building2, FileCheck2, Banknote, Calculator, FileWarning, Bitcoin,
} from "lucide-react";
  ...
  return (
    <div className="fa-root">
      ...
      <nav className={`fa-nav ${navSolid ? "solid" : ""}`}>
        ...
        <Link to="/" className="fa-nav-cta">{fi.navCta}</Link>
      </nav>
