...
import {
  ShieldCheck, Search, Landmark, Briefcase, ArrowRight, CheckCircle2, Quote, Building2, TrendingUp, FileCheck2,
} from "lucide-react";
  ...
  return (
    <div className="fa-root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .fa-intro-card::before {
          content:'FINDING A'; position:absolute; top:18px; right:22px;
      ...
      <nav className={`fa-nav ${navSolid ? "solid" : ""}`}>
        ...
        <Link to="/" className="fa-nav-cta">{fa.navCta}</Link>
      </nav>
