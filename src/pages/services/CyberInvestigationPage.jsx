...
import {
  ...
  Eye, ClipboardCheck, ShieldAlert, Globe, Bug, Radar as RadarIcon, Network,
  FileClock, ChevronDown, Siren,
} from "lucide-react";
  ...
  return (
    <div className="fa-root">
      ...
      <nav className={`fa-nav ${navSolid ? "solid" : ""}`}>
        ...
        <button className="fa-nav-cta">{ci.navCta}</button>
      </nav>
      ...
      <header className="fa-hero">
        ...
        <div className="fa-hero-actions">
          ...
          <button className="fa-btn-ghost">{ci.heroBtnGhost}</button>
        </div>
