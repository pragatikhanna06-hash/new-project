...
import {
  ShieldCheck, Scale, Gavel, Landmark, Briefcase, ArrowRight, CheckCircle2, Quote, Building2, FileWarning, PenTool, FileClock, Printer, FolderCheck, Stamp,
} from "lucide-react";
  ...
  return (
    <div className="fa-root">
      ...
      <nav className={`fa-nav ${navSolid ? "solid" : ""}`}>
        ...
        <Link to="/" className="fa-nav-cta">{de.navCta}</Link>
      </nav>
