...
import {
  ShieldCheck, Scale, Briefcase, ArrowRight, CheckCircle2, Quote, Building2, TrendingUp, UserCheck, Eye, ClipboardCheck, ShieldAlert, Globe,
} from "lucide-react";
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .fa-intro-card::before {
          content:'FILE A'; position:absolute; top:18px; right:22px;
