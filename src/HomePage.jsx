...
//       {/* ── embedded NyayShield content — same markup/functions as the
//           standalone /nyay-shield page, just without its own nav ── */}
...
export default function HomePage() {
  ...
  return (
    <div className="page">
      <Seo
        title="Home"
        description="Forfra Solutions — court-admissible digital forensics, fraud investigation, data security, and legal consultation for government agencies, banks, and corporates across India."
        path="/"
      />
      <Navbar scrolled={scrolled} />
      <HeroSection />
